      ...
      <Card width={"92%"} variant="elevated">
        <CardBody className="post">
          <HStack spacing="13px" align="center" paddingBottom={"0"}>
            ...
            ></Icon>
            <Text fontSize="4xl" className="staffName">
              You
            </Text>
            <Tag colorScheme="blue" size="lg" className="categoryTag">
              CATEGORY 1
            </Tag>
          </HStack>
        </CardBody>
          ...
          {({ isExpanded }) => (
            <>
              <HStack>
                ...
                {isExpanded ? (
                  <>
                    <AccordionButton width={"10%"} _hover={{ bgColor: "none" }}>
                      <HStack>
                        <Button
                          variant="solid"
                          size="lg"
                    ...
                    <SlideFade in={isOpen} marginLeft={"3%"}>
                      <HStack>
                        <Text size="md" className="deleteBtn">
                          Are you sure?
                        </Text>
                ...
                <HStack>
                  ...
                  <div className="col-2 px-0 mx-0 text-center">
                    ...
                    <div className="d-flex justify-content-center align-middle">
                      ...
                      <Icon
                        content={
                          lock ? "fa-solid fa-lock" : "fa-solid fa-lock-open"
                        }
                        fontSize="15px"
                      />
                    </div>
